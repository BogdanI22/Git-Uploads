...
public class Piece {
    ...
    //recieve an image path and return the image.
    ...
    public boolean isValidSqare(int targetCol, int targetRow){
        hittingP = getHittingP(targetCol, targetRow);
        if(hittingP == null){
            return true;
        }
        else{
            //this sqare is ocupied
    ...
    public boolean isSameSqare(int targetCol, int targetRow){
